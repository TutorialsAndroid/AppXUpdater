...
class AppUpdaterUtils(private val context: Context) {
  ...
  interface UpdateListener {
     ...
     * @see com.github.tutorialsandroid.appxupdater.objects.Update
     *
   ...
   * @return this
   * @see com.github.tutorialsandroid.appxupdater.AppUpdaterUtils.AppUpdaterListener
   *
   */
  @Deprecated("")
   ...
   * @return this
   * @see com.github.tutorialsandroid.appxupdater.AppUpdaterUtils.UpdateListener
   */
      ...
      override fun onSuccess(update: Update?) {
        ...
        when {
            ...
            appUpdaterListener != null -> {
              appUpdaterListener!!.onSuccess(update!!.latestVersion, UtilsLibrary.isUpdateAvailable(installedUpdate, update))
            }
            else -> {
